...
*/
$config['tables']['users']           = 'aq_users';
$config['tables']['groups']          = 'aq_groups';
$config['tables']['users_groups']    = 'aq_users_groups';
$config['tables']['login_attempts']  = 'aq_login_attempts';
...
$config['admin_email']                = "admin@eltok.net"; // Admin Email, admin@example.com
